...
import { Orgforgetpassword } from 'src/app/shared/models/orgforgetpassword';
import { Orgresetpassword } from 'src/app/shared/models/orgresetpassword';

@Component({
  selector: 'app-orgresetpassword',
  templateUrl: './orgresetpassword.component.html',
  styleUrls: ['./orgresetpassword.component.scss']
})
export class OrgresetpasswordComponent implements OnInit {
  resetpassword: Orgresetpassword = {organizerToken: '', newPassword: ''};
  currTime: number;
  disable = 'disabled';
  show: boolean;
  oToken='';
  ...
  forgetpassword: Orgforgetpassword = {email_address: ''};
  ...
  ngOnInit(): void {
    this.arouter.queryParams.subscribe(params => {
      this.forgetpassword.email_address = params.email;
  ...
  resend() {
    this.as.orgforgetpassword(this.forgetpassword).subscribe(res => {
  ...
  onSubmit() {
    if (this.resetpasswordFormGroup.valid) {
      ...
      this.resetpassword.organizerToken = token;
      this.resetpassword.newPassword = password;
      this.as.orgresetpassword(this.resetpassword).subscribe(res => {
